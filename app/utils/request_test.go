...
func TestGetPaginationSettings(t *testing.T) {
	...
	tests := map[string][2]int{
		...
		"scenario3": [2]int{gofreta.App.Config.GetInt("pagination.maxLimit") + 1, 9999},
		// normal limit and page
		"scenario4": [2]int{2, 15},
	}

	expected := map[string][2]int{
		"scenario1": [2]int{gofreta.App.Config.GetInt("pagination.defaultLimit"), 1},
		"scenario2": [2]int{gofreta.App.Config.GetInt("pagination.defaultLimit"), 1},
		"scenario3": [2]int{gofreta.App.Config.GetInt("pagination.maxLimit"), int(math.Ceil(float64(total) / float64(gofreta.App.Config.GetInt("pagination.maxLimit"))))},
		"scenario4": [2]int{2, 15},
	}
