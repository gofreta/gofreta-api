...
func TestAuthApi_resetPassword(t *testing.T) {
	...
	testScenarios := []*TestApiScenario{
		...
		&TestApiScenario{
			...
			Params:          map[string]string{"hash": "57592504d04a23698d106d36d18cb498_1767139200"},
			ExpectedCode:    400,
...
func TestAuthenticateToken(t *testing.T) {
	...
	testScenarios := []struct {
		...
		{"", "", "", true},
		{
			"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjAsImlkIjoiNWE3NWVlNjNlMTM4MjMzNjcyOGMyYWRkIiwibW9kZWwiOiJrZXkifQ.hmG6sxqJVIGi3JNzKu83b5mQo0wTON_37bQMdPC6Dco",
			"media", "missing", true,
		},
		{
			"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjAsImlkIjoiNWE3NWVlNjNlMTM4MjMzNjcyOGMyYWRkIiwibW9kZWwiOiJrZXkifQ.hmG6sxqJVIGi3JNzKu83b5mQo0wTON_37bQMdPC6Dco",
		...
		{
			// expired user1 token
			"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1MTkzMjMxOTMsImlkIjoiNWE3YjE1Y2QzZmI5ZGMwNDFjNTViNDVkIiwibW9kZWwiOiJ1c2VyIn0.XYh3G_YKthtaubRN_grW7Etuwkbx934x0Y06bNGtpjc",
			"", "", true,
		},
		{
			// expired user1 token
		...
		{
			// valid user1 token
			"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjAsImlkIjoiNWE3YjE1Y2QzZmI5ZGMwNDFjNTViNDVkIiwibW9kZWwiOiJ1c2VyIn0.-NyTEHroqIMtywLMD1zXA8X1q3a9GBU9m5MMT_SiRh8",
			"", "", false,
		},
		{
			// valid user1 token
