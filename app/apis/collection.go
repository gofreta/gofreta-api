...
func InitCollectionApi(rg *routing.RouteGroup, session *mgo.Session) {
	...
	rg.Get("/collections", authenticateToken(session, "collection", "index"), api.index)
	rg.Post("/collections", authenticateToken(session, "collection", "create"), api.create)
	rg.Get("/collections/<cidentifier>", authenticateToken(session, "collection", "view"), api.view)
	rg.Put("/collections/<cidentifier>", authenticateToken(session, "collection", "update"), api.update)
	rg.Delete("/collections/<cidentifier>", authenticateToken(session, "collection", "delete"), api.delete)
}
