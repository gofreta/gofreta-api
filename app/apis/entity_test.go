...
func TestEntityApi_view(t *testing.T) {
	...
	testScenarios := []struct {
		...
		{
			"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjAsImlkIjoiNWE4YTk4ZGNlMTM4MjMwZWNkOTE1ZDM2IiwibW9kZWwiOiJrZXkifQ.gvRESxjZPJ5TTsuTJIxxTCPs2yf1-aHJ4azIyWnE6jU",
			&TestApiScenario{
				Params:          map[string]string{"cidentifier": "5a833090e1382351eaad3732", "id": "5a8bea3ae1382310bec8076b"},
				ExpectedCode:    403,
				ExpectedContent: []string{`"status":403`, `"data":null`, `"message":`},
